...
from chaosazure.aks.actions import restart_node, stop_node, delete_node, start_managed_clusters, stop_managed_clusters, delete_managed_clusters
...
MANAGED_CLUSTER_BETA = {
    'name': 'ManagedClusterBeta',
    'resourceGroup': 'group'}
