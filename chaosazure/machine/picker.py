...
def pick_machine_randomly(subscribed_resource_groups, subscribed_instances, configured_resource_groups=None):
    machines = pick_machines(subscribed_resource_groups, subscribed_instances, configured_resource_groups)
    return random.choice(machines)


def pick_machines(subscribed_resource_groups, subscribed_machines, configured_resource_groups=None):
    machines = []
